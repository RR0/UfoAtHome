import {Being} from "../actor/Being";
import {WeatherCondition} from "./circumstance/WeatherCondition";
import {Location} from "./circumstance/Location";
 ...
 */
export interface Sighting extends Account, Event {
  /**
   ...
   */
  isThereAnomalousMouvements(): boolean;
   ...
   */
  isTherePhysicalSpatialIncongruities(): boolean;
   ...
   */
  isThereTracesOrEffectsProduced(): boolean;
