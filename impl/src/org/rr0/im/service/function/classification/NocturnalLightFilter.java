 ...
 * @version 0.3
 */
public class NocturnalLightFilter implements Category {
    private static final float MIN_BRIGHTNESS = 90;
    private static Filter instance = new NocturnalLightFilter();

    private NocturnalLightFilter() {
    }

    public String getName() {
        return "NocturnalLight";
    }
