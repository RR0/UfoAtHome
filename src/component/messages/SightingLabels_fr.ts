...
export const sightingLabels_fr: SightingLabels = {
  ...
  observerId: "ID",
  observerTitle: "Titre",
  observerLastName: "Nom de famille",
  observerFirstNames: "Prénoms",
  sightingId: "ID",
  tags: "Mots-clés",
  ...
  decorObserver: "Autre observateur",
  ...
  decorObserverSide: "Emplacement de l'observateur",
  decorObserverSideNone: "Non présent",
