...
export class BodyEditorTexts {
  static readonly en: BodyEditorMessages = {
    ...
    addBody: "Add a body",
    addBodyHintView: "Where the observer is looking now",
    ...
    outlineNode: "Part drawn by the observer",
