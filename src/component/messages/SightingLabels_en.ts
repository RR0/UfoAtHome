...
export const sightingLabels_en: SightingLabels = {
  ...
  assessmentNames: { coverage: "Observer info" },
  assessmentVerdicts: {
  ...
  observerId: "ID",
  observerTitle: "Title",
  observerLastName: "Last name",
  observerFirstNames: "First names",
  sightingId: "ID",
  tags: "Tags",
  ...
  decorModelSource: "Where it came from",
  decorFloors: "Floors",
  decorOccupiedFloor: "Occupied floor",
  decorObserverSide: "Observer location",
  decorObserverSideNone: "Not present",
