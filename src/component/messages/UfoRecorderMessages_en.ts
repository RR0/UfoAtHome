...
export const ufoRecorderMessages_en: UfoRecorderMessages = {
  ...
  skySatellitesLit: "the Earth's shadow stood {height} km above the witness, so low orbit was still in sunlight",
  skySatellitesLitWith: "the Earth's shadow stood {height} km above the witness, so low orbit was still in sunlight — {eras}",
