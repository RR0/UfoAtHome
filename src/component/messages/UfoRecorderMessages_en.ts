...
export const ufoRecorderMessages_en: UfoRecorderMessages = {
  ...
  skyLine: "Sky: {parts}",
  skyShowerActive: "{name} — radiant {altitude}° above the horizon, to the {bearing} — about {rate}/h under this sky",
  ...
  skyComet: "{name}, magnitude {magnitude}, {altitude}° above the horizon to the {bearing}, tail {tail}° long",
  skyCometNoTail: "{name}, magnitude {magnitude}, {altitude}° above the horizon to the {bearing}",
  skyCometBelowHorizon: "{name} was there at magnitude {magnitude}, but below the horizon — nobody here saw it",
  skyCometInDaylight: "{name}, magnitude {magnitude}, {altitude}° above the horizon to the {bearing} — but only {elongation}° from the Sun",
