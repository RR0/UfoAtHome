...
export const ufoRecorderMessages_en: UfoRecorderMessages = {
  ...
  skyOpticsPossible: "ice cloud enough for a 22° halo, with sundogs {parhelia}° to either side of the {source}",
  skyOpticsHaloOnly: "ice cloud enough for a 22° halo — the {source} is too high for sundogs",
