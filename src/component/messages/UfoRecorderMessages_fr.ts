...
export const ufoRecorderMessages_fr: UfoRecorderMessages = {
  ...
  skyLine: "Ciel : {parts}",
  skyShowerActive: "{name} — radiant à {altitude}° de hauteur, au {bearing} — environ {rate}/h sous ce ciel",
  ...
  skyComet: "La {name}, magnitude {magnitude}, à {altitude}° de hauteur au {bearing}, queue longue de {tail}°",
  skyCometNoTail: "La {name}, magnitude {magnitude}, à {altitude}° de hauteur au {bearing}",
  skyCometBelowHorizon: "La {name} était là, magnitude {magnitude}, mais sous l'horizon — personne ici ne l'a vue",
  skyCometInDaylight: "La {name}, magnitude {magnitude}, à {altitude}° de hauteur au {bearing} — mais à {elongation}° du Soleil seulement",
