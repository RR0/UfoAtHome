...
export const ufoRecorderMessages_fr: UfoRecorderMessages = {
  ...
  skyOpticsPossible: "nuages de glace suffisants pour un halo à 22°, avec des parhélies à {parhelia}° de part et d'autre {source}",
  skyOpticsHaloOnly: "nuages de glace suffisants pour un halo à 22° — l'astre est trop haut pour des parhélies",
