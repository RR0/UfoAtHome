...
export const ufoRecorderMessages_fr: UfoRecorderMessages = {
  ...
  skySatellitesLit: "l'ombre de la Terre montait à {height} km au-dessus du témoin, l'orbite basse était donc encore éclairée",
  skySatellitesLitWith: "l'ombre de la Terre montait à {height} km au-dessus du témoin, l'orbite basse était donc encore éclairée — {eras}",
